...
public class ObjetoMain {
    public static void main(String[] args) {
        ...
        // Propriedade Privada só pode ser acessada pela Classe
//        ModificadorPrivate modificador = new ModificadorPrivate();
//        System.out.println(modificador.nomeCompelo("Eddie Van Halen"));
//        System.out.println(modificador.cpf);
//        System.out.println(modificador.rg);
    }
}
